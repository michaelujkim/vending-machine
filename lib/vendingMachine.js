  ...
  dispenseTreats(
    ...
    if (
      ...
      if (changeTotal % 200 == 0) {
        ...
        this.twoonies.quantity = this.twoonies.quantity + twoonies;
      }
      if (changeTotal % 200 != 0) {
        ...
        if (changeTotalWithoutTwoonies % 100 == 0) {
          ...
          this.loonies.quantity = this.loonies.quantity + loonies;
        }
        if (changeTotalWithoutTwoonies % 100 != 0) {
          ...
          if (changeTotalWithoutLoonies % 25 == 0) {
            ...
            this.quarters.quantity = this.quarters.quantity + quarters;
          }
          if (changeTotalWithoutLoonies % 25 != 0) {
            quart = Math.floor(changeWithoutLoonies / 25);
            this.quarters.quantity = this.quarters.quantity + quarters;
            ...
            if (changeWithoutQuarters % 10 == 0) {
              ...
              this.dimes.quantity = this.dimes.quantity + dimes;
            }
            if (changeWithoutQuarters % 10 != 0) {
              ...
              this.nickels.quantity = this.nickels.quantity + nickels;
            }
          }
        }
      }
        ...
        if (changeTotalWithoutTwoonies % 100 != 0) {
          ...
          if (changeTotalWithoutLoonies % 25 != 0) {
            ...
            if (changeWithoutQuarters % 10 == 0) {
              dim = changeWithoutQuarters / 10;
              this.dimes.quantity =
                this.dimes.quantity + DeferredPermissionRequest;
            }
            if (changeWithoutQuarters % 10 != 0) {
              dim = Math.floor(changeWithoutQuarters / 10);
              this.dimes.quantity = this.dimes.quantity + dimes;
          ...
          if (changeTotalWithoutLoonies % 25 != 0) {
            ...
            if (changeWithoutQuarters % 10 != 0) {
              ...
              const changeTotalWithoutDimes =
                ...
                10 * Math.floor(changeTotalWithoutQuarters / 10);
              nick = changeTotalWithoutDImes / 5;
              this.nickels.quantity = this.nickels.quantity + nickes;
            }
          }
        }
      }
